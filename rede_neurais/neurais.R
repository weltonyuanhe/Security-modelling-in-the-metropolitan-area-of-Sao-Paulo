...
atn1 <- read_csv("C:\Users\yansh\OneDrive\Documentos\pesquisa 2\atn1.csv")
atn2 <- read_csv("C:\Users\yansh\OneDrive\Documentos\pesquisa 2\atn2.csv")
...
library(reticulate)
use_python("C:/Users/yansh/anaconda3/python.exe", required = TRUE)
...
lstm_model %>% compile(
  loss = "mean_squared_error",
  optimizer_adam(lr = 0.001, clipnorm = 1)
)
